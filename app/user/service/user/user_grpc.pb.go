...
const (
	...
	UserService_QueryGroupHost_FullMethodName         = "/user.UserService/QueryGroupHost"
...
func (c *userServiceClient) QueryGroupHost(ctx context.Context, in *QueryGroupHostRequest, opts ...grpc.CallOption) (*QueryGroupHostResponse, error) {
	out := new(QueryGroupHostResponse)
	err := c.cc.Invoke(ctx, UserService_QueryGroupHost_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	QueryGroupHost(context.Context, *QueryGroupHostRequest) (*QueryGroupHostResponse, error)
...
func (UnimplementedUserServiceServer) QueryGroupHost(context.Context, *QueryGroupHostRequest) (*QueryGroupHostResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryGroupHost not implemented")
}
...
func _UserService_QueryGroupHost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryGroupHostRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).QueryGroupHost(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_QueryGroupHost_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).QueryGroupHost(ctx, req.(*QueryGroupHostRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryGroupHost",
			Handler:    _UserService_QueryGroupHost_Handler,
		},
		{
