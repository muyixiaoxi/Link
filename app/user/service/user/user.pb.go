...
var file_user_proto_rawDesc = []byte{
	...
	0x28, 0x04, 0x52, 0x08, 0x66, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x49, 0x64, 0x22, 0x2b, 0x0a, 0x10,
	0x47, 0x65, 0x74, 0x4f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x2b, 0x0a, 0x11, 0x47, 0x65, 0x74,
	...
	0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x43, 0x0a, 0x10, 0x53, 0x65, 0x74, 0x4f, 0x66, 0x66,
	...
	0x01, 0x28, 0x04, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x32, 0xbd, 0x0a, 0x0a, 0x0b,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*GetOffsetRequest)(nil),         // 27: user.GetOffsetRequest
	(*GetOffsetResponse)(nil),        // 28: user.GetOffsetResponse
	(*SetOffsetRequest)(nil),         // 29: user.SetOffsetRequest
...
var file_user_proto_depIdxs = []int32{
	...
	27, // 15: user.UserService.GetOffset:input_type -> user.GetOffsetRequest
	29, // 16: user.UserService.SetOffset:input_type -> user.SetOffsetRequest
	0,  // 17: user.UserService.NextUserID:input_type -> user.Empty
	0,  // 18: user.UserService.AddUserId:input_type -> user.Empty
	0,  // 19: user.UserService.DecUserID:input_type -> user.Empty
	10, // 20: user.UserService.UserCreateGroup:input_type -> user.UserCreateGroupRequest
	11, // 21: user.UserService.UserSelectGroup:input_type -> user.UserSelectGroupsRequest
	22, // 22: user.UserService.UserUserSelfGroup:input_type -> user.UserSelfGroupRequest
	15, // 23: user.UserService.UserSelectDetailGroup:input_type -> user.DetailGroupRequest
	2,  // 24: user.UserService.UserCreate:output_type -> user.UserCreateResponse
	2,  // 25: user.UserService.UserCreateRevertLogin:output_type -> user.UserCreateResponse
	4,  // 26: user.UserService.UserLogin:output_type -> user.UserLoginResponse
	6,  // 27: user.UserService.UserInfo:output_type -> user.UserInfoResponse
	0,  // 28: user.UserService.UserUpdateInfo:output_type -> user.Empty
	0,  // 29: user.UserService.UserFlowed:output_type -> user.Empty
	0,  // 30: user.UserService.UserDisposeFlowed:output_type -> user.Empty
	0,  // 31: user.UserService.UserUpdateRemark:output_type -> user.Empty
	19, // 32: user.UserService.UserFriendList:output_type -> user.UserFriendResponse
	19, // 33: user.UserService.UserQueryFriend:output_type -> user.UserFriendResponse
	25, // 34: user.UserService.UserQueryPhone:output_type -> user.UserQueryPhoneResponse
	0,  // 35: user.UserService.UserDeleteFriend:output_type -> user.Empty
	28, // 36: user.UserService.GetOffset:output_type -> user.GetOffsetResponse
	0,  // 37: user.UserService.SetOffset:output_type -> user.Empty
	17, // 38: user.UserService.NextUserID:output_type -> user.NextUserIDResponse
	0,  // 39: user.UserService.AddUserId:output_type -> user.Empty
	0,  // 40: user.UserService.DecUserID:output_type -> user.Empty
	0,  // 41: user.UserService.UserCreateGroup:output_type -> user.Empty
	14, // 42: user.UserService.UserSelectGroup:output_type -> user.UserSelectGroupsResponse
	14, // 43: user.UserService.UserUserSelfGroup:output_type -> user.UserSelectGroupsResponse
	16, // 44: user.UserService.UserSelectDetailGroup:output_type -> user.DetailGroupResponse
