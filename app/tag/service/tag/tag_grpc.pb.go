...
func (c *tagLoginClient) ChooseTags(ctx context.Context, in *ChooseTagsRequest, opts ...grpc.CallOption) (*ChooseTagsResponse, error) {
	out := new(ChooseTagsResponse)
	err := c.cc.Invoke(ctx, TagLogin_ChooseTags_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tagLoginClient) SelectLinkTags(ctx context.Context, in *SelectLinkTagsRequest, opts ...grpc.CallOption) (*SelectLinkTagsResponse, error) {
	out := new(SelectLinkTagsResponse)
	err := c.cc.Invoke(ctx, TagLogin_SelectLinkTags_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTagLoginServer) ChooseTags(context.Context, *ChooseTagsRequest) (*ChooseTagsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChooseTags not implemented")
}
...
func _TagLogin_ChooseTags_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChooseTagsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TagLoginServer).ChooseTags(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TagLogin_ChooseTags_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagLoginServer).ChooseTags(ctx, req.(*ChooseTagsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TagLogin_SelectLinkTags_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SelectLinkTagsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TagLoginServer).SelectLinkTags(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TagLogin_SelectLinkTags_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagLoginServer).SelectLinkTags(ctx, req.(*SelectLinkTagsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TagLogin_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChooseTags",
			Handler:    _TagLogin_ChooseTags_Handler,
		},
		{
...
const (
	...
	TagSign_SignUserChooseTagRevert_FullMethodName = "/tag.TagSign/SignUserChooseTagRevert"
)
...
func (c *tagSignClient) SignUserChooseTagRevert(ctx context.Context, in *UserChooseTagRequest, opts ...grpc.CallOption) (*UserChooseTagRequest, error) {
	out := new(UserChooseTagRequest)
	err := c.cc.Invoke(ctx, TagSign_SignUserChooseTagRevert_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TagSignServer interface {
	...
	SignUserChooseTagRevert(context.Context, *UserChooseTagRequest) (*UserChooseTagRequest, error)
...
func (UnimplementedTagSignServer) SignUserChooseTagRevert(context.Context, *UserChooseTagRequest) (*UserChooseTagRequest, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignUserChooseTagRevert not implemented")
}
...
func _TagSign_SignUserChooseTagRevert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserChooseTagRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TagSignServer).SignUserChooseTagRevert(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TagSign_SignUserChooseTagRevert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagSignServer).SignUserChooseTagRevert(ctx, req.(*UserChooseTagRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TagSign_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SignUserChooseTagRevert",
			Handler:    _TagSign_SignUserChooseTagRevert_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "app/tag/service/tag.proto",
